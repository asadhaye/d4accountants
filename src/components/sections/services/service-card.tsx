  ...
  return (
    <Link href={service.href} className="group">
      <motion.div variants={fadeIn} className="relative h-full">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-teal-500/20 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300" />
        <Card className="relative h-full bg-white/5 backdrop-blur-xl border-blue-500/10 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
          ...
          <CardFooter>
            <Button className="w-full bg-white/5 text-teal-400 hover:bg-blue-500/20 hover:text-teal-300 border border-blue-500/10 hover:border-teal-500/20 transition-colors">
              Learn More
            </Button>
          </CardFooter>
        </Card>
