    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="mt-4">Additionally, as you browse the Site, we collect information about the individual web pages or products that you view, what websites or search terms referred you to the Site, and information about how you interact with the Site. We refer to this automatically-collected information as "Browsing Information".</p>
          
          <div className="mt-4">
            <p>We collect Browsing Information using the following technologies:</p>
            <ul className="list-disc pl-8 mt-2 space-y-2">
              <li>"Cookies" are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit <a href="http://www.allaboutcookies.org" className="text-blue-600 hover:underline">http://www.allaboutcookies.org</a>.</li>
        ...
        <section>
          ...
          <p className="mt-4">When we talk about "Your Personal Information" in this Privacy Policy, we are talking both about Browsing Information and Purchase Information.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4">We use the Browsing Information that we collect to help us screen for potential risk and fraud (in particular, your IP address), and more generally to improve and optimize our Site (for example, by generating analytics about how our customers browse and interact with the Site, and to assess the success of our marketing and advertising campaigns).</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">SHARING YOUR PERSONAL INFORMATION</h2>
          <p>We may share Your Personal Information with third parties to help us use Your Personal Information, as described above. For example, we may use Google Analytics to help us understand how our customers use the Site — you can read more about how Google uses your Personal Information here: <a href="https://www.google.com/intl/en/policies/privacy" className="text-blue-600 hover:underline">https://www.google.com/intl/en/policies/privacy</a>. You can also opt-out of Google Analytics here: <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-600 hover:underline">https://tools.google.com/dlpage/gaoptout</a>.</p>
        ...
        <section>
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc pl-8 mt-2 space-y-2">
              <li><a href="https://www.facebook.com/settings/?tab=ads" className="text-blue-600 hover:underline">Facebook</a></li>
              <li><a href="https://www.google.com/settings/ads/anonymous" className="text-blue-600 hover:underline">Google</a></li>
              <li><a href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads" className="text-blue-600 hover:underline">Bing</a></li>
            </ul>
          </div>
          
          <p className="mt-4">Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance's opt-out portal at: <a href="http://optout.aboutads.info" className="text-blue-600 hover:underline">http://optout.aboutads.info</a>.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4">Additionally, if you are a European resident we note that we are processing your information in order to fulfill contracts we might have with you (for example if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above. Additionally, please note that your information may be transferred outside of Europe, including to Canada and the United States.</p>
        </section>
